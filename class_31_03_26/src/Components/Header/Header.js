    ...
    return (
        <header className="header">
            <div className="container">
                <img src="/images/burger.svg" className="burger" />

                <Link to="/" className="logoWrap">
                    <img src="/images/logo.svg" className="logoImage" />
                </Link>

                <Link to="/catalog" className="catalogBtn">
                ...
                <div className="searchWrap">
                    <input
                        ...
                        placeholder="Я шукаю..."
                    />
                    <button className="searchBtn">Знайти</button>
                </div>
                ...
                <div className="icons">
                    ...
                    <div className="iconWrap">
                        <img src="/images/scale.svg" className="icon" />
                    </div>
                    <div className="iconWrap">
                        <img src="/images/cart.svg" className="icon" />
                    </div>
                </div>
            </div>
        </header>
